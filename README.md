...
Version actuelle : **1.1.0** (voir `pyproject.toml`), **statut stable** (classifier PyPI `Development Status :: 5 - Production/Stable`), licence **MIT** (SPDX), versioning **SemVer**, tags de release `vMAJOR.MINOR.PATCH`.
